...
const EditRider = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                console.error('Error fetching rider:', error); // Use console.error instead of console.warn
                setState((prevState) => ({
                    ...prevState,
                    loading: false,
                    errorMessage: error.message,
    ...
    let submitForm = async (event) => {
        ...
        try {
            ...
            console.error('Error updating rider:', error); // Use console.error instead of console.warn
            setState({
                ...state,
                errorMessage: error.message
            });
